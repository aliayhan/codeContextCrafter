# Copyright 2023-2024 Paul Gauthier (Original Aider project)
# Copyright 2025 CodeContextCrafter Contributors (Modifications)
#
...
#
# This file is derived from Aider v0.86.1 (https://github.com/Aider-AI/aider)
# and has been modified for CodeContextCrafter. See FORK_INFO.md for details.
...
from codecontextcrafter.aider.dump import dump
from codecontextcrafter.aider.special import filter_important_files
from codecontextcrafter.aider.waiting import Spinner
...
class RepoMap:
    ...
    def __init__(
        ...
        self.sig_detailed = sig_detailed
    ...
    def get_repo_map(
        ...
        if self.max_map_tokens is not None and self.max_map_tokens <= 0:
            return
        if not other_files:
            return
        ...
        padding = 4096
        if max_map_tokens is not None and max_map_tokens and self.max_context_window:
            target = min(
    ...
    def render_tree(self, abs_fname, rel_fname, lois):
        ...
        if (
            ...
            context = TreeContext(
                ...
                color=False,
                line_number=False,
                child_context=self.sig_detailed,
                last_line=False,
                margin=0,
                mark_lois=False,
                loi_pad=0,
    ...
    def to_tree(self, tags, chat_rel_fnames):
        ...
        output = "\n".join([line[:1000] for line in output.splitlines()]) + "\n"
